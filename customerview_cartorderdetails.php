...
<body>
    ...
    <div class="container-fluid">
        ...
        <head>
            <meta charset="utf-8">
            <title>Cart Order Details</title>
            <meta charset="utf-8">
            <!-- <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script> -->
        ...
        <body>
            <div class="form">
                ...
                <h1>Cart Order details</h1>
                <a href="customerview_cartorder.php">Back to Order list</a>
                <table class="table table-stripped">
                    ...
                    <tbody>
                        ...
                        $_SESSION["cartorderid"] = $cartorderid;
                        $count = 1;
                        $sql_query = "Select * from cartorder_details where cartorderid='$cartorderid';";
