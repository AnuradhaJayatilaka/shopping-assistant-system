                    ...
                    <body>
                        ...
                        <!-- <th><strong>Number</strong></th> -->
                                ...
                                <tbody>
                                    <?php
                                        $count=1;
                                        $sel_query="Select * from cartorder Where cart_order_status='Placed' OR  cart_order_status='processing' order  by cartorderid asc ";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td align="center">
                                              <form action= "ccartorder1.php" method="GET">
                                            ...
                                            <form action= "ccartorder2.php" method="GET">
                                              <input type="hidden" name="cart_order_status" >
                                              <input type="hidden" name="cartorderid" value=<?php echo $row["cartorderid"] ?>>
