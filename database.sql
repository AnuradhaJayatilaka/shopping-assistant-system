...
INSERT INTO `users` (`email_address`, `user_name`, `NIC`, `user_type`, `mobile_number`, `title`, `password`) VALUES (VERSION(), 'Saman Ratnayake', '905555555v', 'Cashier', '0782222222', 'Mr.', 'cashier123');
