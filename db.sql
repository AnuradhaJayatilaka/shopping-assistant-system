...
-- ALTER TABLE orders ADD Y-m-d H:i:s DATE not NULL;
DROP TABLE IF EXISTS orders;
CREATE TABLE IF NOT EXISTS orders (
  `username` varchar(30) NOT NULL,
  `orderid` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE suggestions(  `username` varchar(30) NOT NULL,
  ...
  CREATE TABLE cart('email_address' VARCHAR(30) NOT NULL,product_name VARCHAR(30) NOT NULL,quantity_needed DOUBLE(10) NOT NULL);
...
quantity_needed DOUBLE(10) NOT NULL,
